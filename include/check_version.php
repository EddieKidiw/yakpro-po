...
$php_parser_git_commandline = 'composer install';

if(!file_exists("$yakpro_po_base_directory/vendor/nikic/php-parser/composer.json"))
{
...
$t_composer             = json_decode(file_get_contents("$yakpro_po_base_directory/vendor/nikic/php-parser/composer.json"));   //print_r($t_composer);
